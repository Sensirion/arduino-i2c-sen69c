# Sensirion I²C SEN69C Arduino Library

This is the Sensirion SEN69C library for Arduino allowing you to
communicate with a SEN69C sensor
over I²C.
...
Search for the `Sensirion I2C SEN69C` library in the `Filter
...
Use the following pin description to connect your SEN69C to the standard I²C bus of your Arduino board:
...
| *SEN69C* | *SEN69C Pin* | *Cable Color* | *Board Pin* |
| :---: | --- | --- | --- |
| VDD | 1 | red | 3.3V |
| GND | 2 | black | GND |
| SDA | 3 | green | D18/SDA |
...
2. Connect the SEN69C sensor to your Arduino as explained in [Connect the sensor](#connect-the-sensor)

3. Open the `exampleUsage` sample project within the Arduino IDE:

   `File` ➔ `Examples` ➔ `Sensirion I2C SEN69C` ➔ `exampleUsage`
